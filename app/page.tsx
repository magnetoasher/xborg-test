  ...
  return (
    <>
      <main className="min-w-full">
        ...
        >
          <div
            className="mb-[8vh] bg-transparent"
            style={{ position: 'relative' }}
          >
            <Image
            ...
            >
              <div className="md:w-1/2 w-full bg-transparent">
                <motion.h1
                  ...
                  className={`uppercase bg-transparent text-[40px] leading-[1] font-integral text-[#F0F0F0] max-w-[380px]`}
                >
                  The New Gaming Web
                </motion.h1>
                <motion.p
                ...
                >
                  ...
                  and interconnected network of gaming profiles. Each player's
                      ...
                      {index === activeIndex ? (
                        ...
                        >
                          ...
                          >
                            ...
                            <span className="text-white bg-transparent">:</span>
                            {` `}
                            <span className="text-[#EB3A4A]  bg-transparent">
                              25
                            </span>
                            {`, "achievements"`}
                            <span className="text-white bg-transparent">{`: [`}</span>
                            {`"Master of the Arena", "Legendary Explorer"`}
                            <span className="text-white bg-transparent">{`],`}</span>
                            {`"total_score": `}
                            <span className="text-[#EB3A4A] bg-transparent">
                              2000
